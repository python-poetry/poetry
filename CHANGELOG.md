...
- Fix an issue where `poetry check` falsely reported that an invalid source "pypi" is referenced in dependencies ([#9436](https://github.com/python-poetry/poetry/pull/9436)).
