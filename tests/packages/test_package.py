...
def test_package_authors():
    ...
    package.authors.insert(0, "Raphaël Yancey <raphael@badfile.net>")  # With combining diacritics (ë = e + ¨ = e\u0308)
    assert package.author_name == "Raphaël Yancey"  # Is normalized into \u00EB
    assert package.author_email == "raphael@badfile.net"

    package.authors.insert(0, "Raphaël Yancey <raphael@badfile.net>")  # Without (ë = \u00EB)
