...
def test_activate_activates_different_virtualenv_with_envs_file(
    ...
    m.assert_called_with(
        ...
        flags={"always-copy": False, "prompt": "simple-project-py3.6"},
    )
...
def test_create_venv_uses_patch_version_to_detect_compatibility(
    ...
    m.assert_called_with(
        ...
        flags={
            "always-copy": False,
            "prompt": "simple-project-py{}.{}".format(version.major, version.minor),
        },
    )
...
def test_create_venv_uses_patch_version_to_detect_compatibility_with_executable(
    ...
    m.assert_called_with(
        ...
        flags={
            "always-copy": False,
            "prompt": "simple-project-py{}.{}".format(version.major, version.minor - 1),
        },
    )
