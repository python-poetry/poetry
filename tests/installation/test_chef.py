...
def test_no_backslashes_with_file_protocol(config, mocker):
    ...
    mocked_cache_dir = Path(
        "C:\\Users\\johnsmith\\AppData\\Local\\pypoetry\\Cache\\artifacts\\96\\15\\17\\6dc4596b5827e94647f1e4e7362bec368fcdda2100141109ada8a1e3dd"
    )
    archive = Path(
        "C:\\Users\\johnsmith\\AppData\\Local\\pypoetry\\Cache\\artifacts\\96\\15\\17\\6dc4596b5827e94647f1e4e7362bec368fcdda2100141109ada8a1e3dd\\zipp-1.2.0-py2.py3-none-any.whl"
    )
    expected = "file://" + str(archive.as_posix())

    mocker.patch.object(
        chef, "get_cache_directory_for_link", return_value=mocked_cache_dir,
    )

    mocker.patch.object(
        Path, "glob", return_value=[archive],
    )
