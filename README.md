...
Poetry provides a custom installer that will install `poetry` isolated from the rest of your system by vendorizing its dependencies. This is the recommended way of installing `poetry`. For full details, see the following: https://poetry.eustace.io/docs/#installation.

### Updating `poetry`

On details in relation to updating `poetry`, see the following: https://poetry.eustace.io/docs/#updating-poetry.

### Enable tab completion for Bash, Fish, or Zsh

`poetry` supports generating completion scripts for Bash, Fish, and Zsh. For full details, see `poetry help completions`, but a summary can be found here: https://poetry.eustace.io/docs/#enable-tab-completion-for-bash-fish-or-zsh.

### Commands

From above we've learned how to use the command-line interface, the following link documents the available commands: https://poetry.eustace.io/docs/cli/.

### The `pyproject.toml` file

The `tool.poetry` section of the `pyproject.toml` file is composed of multiple sections, detailed in the following link: https://poetry.eustace.io/docs/pyproject/.

### Versions and constraints

Poetry recommends following semantic versioning but will not enforce it.

In summary, Poetry has the following version contraints:
* **Caret requirements**.
* **Tilde requirements**.
...
For more information, see here: https://poetry.eustace.io/docs/versions/.
...
Accordingly, `poetry` can be installed globally and used everywhere.
...
The reasons are, in summary, as follows:
